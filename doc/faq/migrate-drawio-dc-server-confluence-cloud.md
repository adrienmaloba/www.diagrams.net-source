...
Now that [Atlassian supports bulk space permissions editing in Cloud](https://jira.atlassian.com/browse/CONFCLOUD-1053), we strongly recommend you [use the original ``Page IDs`` method](/doc/faq/migrate-drawio-confluence.html), especially if you are: 
