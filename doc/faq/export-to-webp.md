...
2. Change the export settings to suit your requirements.
   * Choose the _Zoom_ factor, set a _Border Width_ around your diagram.
   ...
   * To force your diagram to display in [dark mode](/blog/dark-mode-diagram-editor.html), change the _Appearance_ to _Dark_. 
