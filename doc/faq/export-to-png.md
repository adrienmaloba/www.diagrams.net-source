...
2. Change the export settings to suit your requirements.
   ...
   * If you want to force your diagram to appear in dark mode on a dark background, select the Dark _Appearance_. 
   * If you only want to export the shapes and connectors that are currently selected, enable the _Selection only_ checkbox. 
   * Make sure the checkbox to _Include a copy of my diagram_ is selected if you want to be able to open your diagram and edit it again when you import the PNG file into draw.io. Choose whether you want to include the entire multi-page diagram (default) or just the page that is open in the editor.
...
3. Click _Export_ and select the location to save your PNG file.