...
**Software developers** draw gitflows, UML diagrams including activity diagrams, state charts, user flows, mockups, architecture diagrams, database models, entity relationship diagrams, dependency graphs, [sequence diagrams](/blog/sequence-diagrams.html), and [C4 models](blog/c4-modelling.html).
