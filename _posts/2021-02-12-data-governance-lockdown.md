...
[Atlassian allows you set your **data residency** region](https://confluence.atlassian.com/cloud/manage-data-residency-976763149.html) to choose where your data or _in-scope product content_ resides. That means the content of your instance and associated metadata will be stored on servers in that region when it is at rest. The draw.io apps for Confluence and Jira Cloud will automatically use your Atlassian data residency settings.
