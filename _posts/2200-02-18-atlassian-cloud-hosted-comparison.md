...
**Lockdown data transmission** with configuration options. If you want to prevent all data traffic apart from between the your browser and your Atlassian instance server, set ``lockdown`` in the draw.io configuration (advanced edition only).
