...
The viewer toolbar lets you export a diagram as an image from the online draw.io application, as well as from the draw.io branded Atlassian integrations for Confluence and Jira Cloud and Server/Data Center that draw.io Ltd. builds, delivers and maintains alongside the draw.io and desktop apps.
