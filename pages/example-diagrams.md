...
- [IT and infrastructure diagrams](#it-and-infrastructure-diagrams)
  - [Security](#security)
  - [Rack and cabinet diagrams](#rack-and-cabinet-diagrams)
- [Tree diagrams and org charts](#tree-diagrams-and-org-charts)
- [Mindmaps and concept maps](#mindmaps-and-concept-maps)
- [Industry and engineering](#industry-and-engineering)
  - [Circuit and logic diagrams](#circuit-and-logic-diagrams)
  - [Ishikawa (fishbone) diagrams](#ishikawa-fishbone-diagrams)
- [Flowcharts](#flowcharts)
  - [Swimlane diagrams and cross-functional flowcharts](#swimlane-diagrams-and-cross-functional-flowcharts)
...
<br />[C4 models](/blog/c4-modelling.html): system context, container, component & class diagrams  | [_Download_](https://raw.githubusercontent.com/jgraph/drawio-diagrams/dev/examples/aws-simple-architecture.drawio)
...
[<img src="/assets/img/blog/uml-2-5-composite-structure-diagram-example.png" style="width=100%;max-width:400px;height:auto;" alt="Composite structure diagrams are used to show the internal structure of a classifier">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&page=1&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fdev%2Fexamples%2Fuml-composite-structure-collaboration-use-example.drawio)
...
[<img src="/assets/img/blog/uml-2-5-deployment-diagram-example.png" style="width=100%;max-width:300px;height:auto;" alt="Deployment diagrams shows the system infrastructure and how various software executables and artifacts are deployed on deployment targets.">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&page=1&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fdev%2Fexamples%2Fuml-deployment-example.drawio)
...
<br />3D AWS diagram, as [exported from Cloudockit](/blog/cloudockit-to-drawio.html) | [_Download_](https://raw.githubusercontent.com/jgraph/drawio-diagrams/dev/templates/cloud/aws_3d_2.xml)
...
[<img src="/assets/img/blog/threat-modeling-data-flow-example.png" style="width=100%;max-width:300px;height:auto;" alt="Data flow diagram for threat modelling">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fdev%2Fblog%2Fthreat-modelling.drawio) [<img src="/assets/img/blog/threat-modelling-process-flow2.png" style="width=100%;max-width:300px;height:auto;" alt="Process flow diagram for threat modelling">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&page=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fdev%2Fblog%2Fthreat-modelling.drawio)
<br />[Threat modelling](/blog/threat-modelling.html) | [_Download_](https://raw.githubusercontent.com/jgraph/drawio-diagrams/dev/blog/threat-modelling.drawio)
...
[<img src="/assets/img/blog/template-business_model_1.png" style="width=100%;max-width:200px;height:auto;" alt="Enterprise business model template">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fdev%2Ftemplates%2Fbusiness%2Fbusiness_model_1.xml)
<br />Enterprise business model (template library) | [_Download_](https://raw.githubusercontent.com/jgraph/drawio-diagrams/dev/templates/business/business_model_1.xml)

[<img src="/assets/img/blog/template-business_model_canvas_1.png" style="width=100%;max-width:300px;height:auto;" alt="Enterprise business model template">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fdev%2Ftemplates%2Fbusiness%2Fbusiness_model_canvas_1.xml)
<br />Business model canvas (template library) | [_Download_](https://raw.githubusercontent.com/jgraph/drawio-diagrams/dev/templates/business/business_model_canvas_1.xml)

[<img src="/assets/img/blog/story-mapping-example-purchase-groceries.png" style="width=100%;max-width:400px;height:auto;" alt="An example of a use case diagram">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fmaster%2Fblog%2Fstory-map.drawio)
<br />[Customer story map](/blog/story-mapping.html) for purchasing groceries online | [_Download_](https://raw.githubusercontent.com/jgraph/drawio-diagrams/dev/blog/story-map.drawio)

[<img src="/assets/img/blog/template-attract-convert-close-delight.png" style="width=100%;max-width:300px;height:auto;" alt="Template for inbound marketing - attract, convert, close, delight">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fmaster%2Ftemplates%2Fbusiness%2Faccd.xml)
<br />Inbound marketing flow (template library) | [_Download_](https://raw.githubusercontent.com/jgraph/drawio-diagrams/dev/templates/business/accd.xml)
...
[<img src="/assets/img/blog/infographic-example-1.png" style="width=100%;max-width:300px;height:auto;" alt="Set the connector shape to curved and pull out the middle waypoint">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fdev%2Fexamples%2Finfographic-example-1.drawio)
...
[<img src="/assets/img/blog/infographic-example-2.png" style="width=100%;max-width:300px;height:auto;" alt="Set the connector shape to curved and pull out the middle waypoint">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fdev%2Fexamples%2Finfographic-example-2.drawio)
...
[<img src="/assets/img/blog/infographic-example-3.png" style="width=100%;max-width:400px;height:auto;" alt="Set the connector shape to curved and pull out the middle waypoint">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fdev%2Fexamples%2Finfographic-example-3.drawio)
...
[<img src="/assets/img/blog/infographic-example-4.png" style="width=100%;max-width:400px;height:auto;" alt="Set the connector shape to curved and pull out the middle waypoint">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fdev%2Fexamples%2Finfographic-example-4.drawio)
...
[<img src="/assets/img/blog/infographic-example-5.png" style="width=100%;max-width:500px;height:auto;" alt="Set the connector shape to curved and pull out the middle waypoint">](https://viewer.diagrams.net/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=#Uhttps%3A%2F%2Fraw.githubusercontent.com%2Fjgraph%2Fdrawio-diagrams%2Fdev%2Fexamples%2Finfographic-example-5.drawio)
